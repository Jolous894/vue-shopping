          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                @click="changeAtive(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)"
                >{{spuSaleAttrValue.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="skuNum" @change="changeSukNum">
...
<script>
  ...
  export default {
    ...
    methods:{
       ...mapActions('detail',['getGoodInfo','addOrUpdateShopCart']),
       //商品详情属性选择
       changeAtive(spuSaleAttrValue,arry){
       ...
       async addShopCar(){
        try {
          await this.addOrUpdateShopCart({skuID:this.$route.params.skuid,skuNum:this.skuNum})
    ...
    mounted(){
     this.getGoodInfo(this.$route.params.skuid)
    },
  }
</script>
