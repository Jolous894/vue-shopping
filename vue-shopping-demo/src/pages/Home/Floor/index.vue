<template>
  <!--楼层-->
  <div>
    <div class="floor" v-for="f in floorList" :key="f.id">
        ...
        <div class="title clearfix">
          ...
          <div class="fr">
            <ul class="nav-tabs clearfix">
              <li
                :class="navIndex == 0 ? 'active' : null"
                v-for="(nav, navIndex) in f.navList"
                :key="navIndex"
              >
                <a data-toggle="tab">{{ nav.text }}</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="tab-content">
          <div class="tab-pane">
            <div class="floor-1">
              <div class="blockgary">
                <ul class="jd-list">
                  <li v-for="(keyword, keyIndex) in f.keywords" :key="keyIndex">
                    {{ keyword }}
                  </li>
                </ul>
                <img :src="f.imgUrl" />
              ...
              <div class="floorBanner">
                <div class="swiper-container" id="floor1Swiper" ref="floorSwiper">
                  <div class="swiper-wrapper">
                    <div
                      class="swiper-slide"
                      v-for="carousel in f.carouselList"
                      :key="carousel.id"
                    >
